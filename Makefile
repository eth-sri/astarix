...
eval150: $(ASTARIXBIN)
	...
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/illumina150.fq -o $(TMPDIR)/ecoli_head1000000_linear/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 --astar_seeds_backwards_algo dfs_for_linear
...
eval250: $(ASTARIXBIN)
	...
	$(ASTARIXBIN) align-optimal -a astar-prefix -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/illumina250.fq -o $(TMPDIR)/ecoli_head1000000_linear_eval250/astar-prefix $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 --astar_seeds_max_indels 5 --astar_seeds_backwards_algo dfs_for_linear
...
eval_long_ccs: $(ASTARIXBIN)
	...
	#$(ASTARIXBIN) align-optimal -a astar-seeds-exact -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long.fq -o $(TMPDIR)/ecoli_head1000000_linear_long_reads/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 $(RUNFLAGS) 
	#$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_1000_ccs/ecoli_100.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_1000_ccs/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear --astar_seeds_len 14 --tree_depth 12 --astar_seeds_max_indels 15
...
#	$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_500_clr/ecoli_10.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_500_clr/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 2 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear --astar_seeds_len 12 --tree_depth 12 --astar_seeds_max_indels 10
	...
	#$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_500_clr/ecoli_10.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_500_clr/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 2 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear --astar_seeds_len 14 --tree_depth 12 --astar_seeds_max_indels 20
#	$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_clr/ecoli_10.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_clr/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 2 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear --astar_seeds_len 14 --tree_depth 12 --astar_seeds_max_indels 20
	#$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_1000_clr/ecoli_100.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_1000_clr/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 2 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear --astar_seeds_len 14 --tree_depth 12 --astar_seeds_max_indels 25
...
chr22_linear: $(ASTARIXBIN)
	...
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 1 -g $(DATADIR)/chr22_linear/HG_22_linear.gfa -q $(DATADIR)/chr22_linear/chr22_100.fq -o $(TMPDIR)/chr22_linear/astar-seeds $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 -G 5 -S 1 --astar_seeds_backwards_algo dfs_for_linear
