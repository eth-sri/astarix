...
eval_long_ccs: $(ASTARIXBIN)
	...
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 6 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_ccs/ecoli_100.fq -o $(TMPDIR)/ecoli_head1000000_linear_long_ccs/astar-default $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 6 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_ccs/ecoli_100.fq -o $(TMPDIR)/ecoli_head1000000_linear_long_ccs/astar-default $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 1 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear

eval_long_clr: $(ASTARIXBIN)
	$(shell mkdir -p $(TMPDIR))
	#$(ASTARIXBIN) align-optimal -a astar-seeds -t 6 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_clr/ecoli_100.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_clr/astar-default $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 0 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 6 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_clr/ecoli_100.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_clr/astar-default $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 2 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear
	$(ASTARIXBIN) align-optimal -a astar-seeds -t 6 -g $(DATADIR)/ecoli_head1000000_linear/graph.gfa -q $(DATADIR)/ecoli_head1000000_linear/long_clr/ecoli_100.fastq -o $(TMPDIR)/ecoli_head1000000_linear_long_clr/astar-default $(RUNFLAGS) --fixed_trie_depth 1 --astar_seeds_max_errors 1 -G 1 -S 1  --astar_seeds_backwards_algo dfs_for_linear
